...
import m.vita.module.track.service.PowerEstimator;
...
public class Threeg extends PowerComponent {
	...
	private static final String TAG = "NT1Threeg";
	...
	public IterationData calculateIteration(long iteration) {
		...
		// Branch For Before ICS
		long transmitPackets = TrafficStats.getMobileTxPackets();
		long receivePackets = TrafficStats.getMobileRxPackets();
		...
		if (transmitPackets == TrafficStats.UNSUPPORTED || receivePackets == TrafficStats.UNSUPPORTED ||
				transmitBytes == TrafficStats.UNSUPPORTED || receiveBytes == TrafficStats.UNSUPPORTED) {
...
//				double deltaTime = curTime - lastTime;
				...
				int timeMult = 1;
//				if (Global.resource_time % PowerEstimator.ITERATION_INTERVAL != 0) {
