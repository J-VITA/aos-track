...
public class GPS extends PowerComponent {
	...
	private static final String TAG = "NT1GPS";
	...
	public GPS(final Context context, PhoneConstants constants) {
		...
		if (gpsStatusFile.exists()) {
			...
			try {
				...
				Log.w(TAG, "Could not parse sdk version: " + Build.VERSION.SDK_INT);
			}
		}
		/*
