...
//                Global.logOut(Global.LOG_TAG, String.format("name=%s, pid=%d, uid=%d, foreground=%b, cpuacct=%s, cpu=%s",
...
//                        name, pid, uid, foreground, cpuacct.toString(), cpu.toString()));
            ...
            uid = status.getUid();
//            Global.logOut(Global.LOG_TAG, String.format("name=%s, pid=%d, uid=%d foreground=%b", name, pid, uid, foreground));
        }
