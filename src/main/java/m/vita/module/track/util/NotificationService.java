...
import m.vita.module.track.track.PowerNotifications;


public class NotificationService {
	private static final String TAG = "NT1NotificationService";
	...
	private static class NotificationForwarder extends DefaultReceiver {
		public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
			...
			synchronized (hooks) {
				for (Iterator<PowerNotifications> iter = hooks.iterator(); iter
						.hasNext();) {
	...
	/*
	 * If you only want to receive a subset of the notifications just extend
	 * this class and override the methods you care about.
	 */
