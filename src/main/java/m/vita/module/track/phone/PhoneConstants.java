...
/* Delete End */
	...
	/*
	 * Gives the packet rate needed to transition from the low power state to
	 * the high power state.
	 */
	public double wifiLowHighTransition();

	/*
	 * Gives the packet rate needed to transition from the high power state to
	 * the low power state.
	 */
	 ...
	 * should be in increasing order. Should have the same number of elements as
	 * wifiLinkRatios().
	 */
	...
	/*
	 * Gives the time in seconds that the 3G interface stays idle in the DCH
	 * state before transitioning to the FACH state.
	 */
	...
	/*
	 * Gives the power consumed by each of the sensors. Should have the same
	 * size as Sensors.MAX_SENSORS.
	 */
