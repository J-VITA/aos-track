...
public class DreamConstants implements PhoneConstants {
	 ...
	 * these thing's power usage but for the developer it's definitely
	 * interesting to get some (perhaps rough?) idea of how much power sensors
	 * are using.
	 */
	...
	public double[] oledChannelPower() {
		throw new RuntimeException(
				"oledChannelPower() called on device with no " + "OLED display");
	}
