...
public class PassionConstants extends DreamConstants {
	...
	public double oledBasePower() {
		return 365; // This incorporates all the constant component in the
					// model.
	}

	private static final double[] arrayChannelPower = { 3.0647e-006,
			4.4799e-006, 6.4045e-006 };
	...
	private static final double[] arrayCpuPowerRatios = { 1.1273, 1.5907,
			1.8736, 2.1745, 2.6031, 2.9612, 3.1373, 3.4513, 3.9073, 4.1959,
			4.6492, 5.4818 };
	...
	private static final double[] arrayCpuFreqs = { 245, 384, 460, 499, 576,
			614, 653, 691, 768, 806, 845, 998 };
	...
	private static final double[] arrayWifiLinkRatios = { 47.122645, 46.354821,
			43.667437, 43.283525, 40.980053, 39.44422, 38.676581, 34.069637,
	...
	private static final double[] arrayWifiLinkSpeeds = { 1, 2, 5.5, 6, 9, 11,
			12, 18, 24, 36, 48, 54 };
